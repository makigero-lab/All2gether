/**
 * Catch-all proxy: /api/fornecedor/[...path]
 *
 * Encaminha pedidos para /api/fornecedor/* do frontend para o backend,
 * injetando o token JWT do cookie httpOnly no header Authorization.
 *
 * FIX (portal lavandaria) — Proxy para o portal do fornecedor (lavandaria).
 *
...
async function proxyHandler(
  ...
  try {
    ...
    const backendUrl = buildBackendUrl(`/api/fornecedor/${pathString}`, queryString);
